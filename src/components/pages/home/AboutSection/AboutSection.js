            ...
            <Container>
                <div className="about-content">
                    <div about-image-container>
                        <img className='about-image' alt="About us" src={AboutImage} />
                    </div>
                    <div about-text-container>
                        ...
                        <Link to='projects' smooth={true} duration={100} offset={-100}><BigButton type='secondary' text='Learn More' /></Link>
