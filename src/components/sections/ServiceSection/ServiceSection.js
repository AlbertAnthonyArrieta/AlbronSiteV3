            ...
            <Container >
                ...
                <div className="services-container" style={{ backgroundImage: `url(${selectedService.bgImage})` }}>
                    <div className="service-focus">
                        ...
                        <BigButton type="secondary" text="Learn More" />
                    </div>
                    <div className="service-list">
                        <ServiceItem name="Engineering Design & Drafting" number="01" focused={selectedService.focused === 'Engineering Design & Drafting'} onClick={() => setSelectedService({ title: 'Engineering Design & Drafting', desc: 'We are a team of professional Mechanical Designers with extensive experience in Oil & Gas, Power Generation and various equipment fabrication. Our main goal is to provide the highest quality mechanical design and drawing package on schedule and on budget.', bgImage: EngImage, focused: 'Engineering Design & Drafting' })} />
                        <ServiceItem name="As Built" number="02" focused={selectedService.focused === 'As Built'} onClick={() => setSelectedService({ title: 'As Built', desc: 'At Albron DGS Inc, our As-Built services bridge the gap between the design plans and the final constructed facility. We understand that in the real world, construction often deviates from original designs due to various on-site adjustments. Our As-Built documentation accurately reflects these changes, ensuring that your records match the existing structure in every detail.', bgImage: BuiltImage, focused: 'As Built' })} />
                        <ServiceItem name="3D Scanning" number="03" focused={selectedService.focused === '3D Scanning'} onClick={() => setSelectedService({ title: '3D Scanning', desc: 'Our 3D Scanning services revolutionize the way you capture and visualize physical spaces and objects. Using cutting-edge technology, we offer a fast, accurate, and non-intrusive method to digitally capture the shape of physical objects, creating precise 3D models for a variety of applications.', bgImage: ScanImage, focused: '3D Scanning' })} />
                        <ServiceItem name="3D Animation" number="04" focused={selectedService.focused === '3D Animation'} onClick={() => setSelectedService({ title: '3D Animation', desc: 'Our 3D Animation services are dedicated to transforming your ideas and designs into vibrant, dynamic animations. Ideal for visualizing complex engineering concepts or presenting architectural designs, our animations offer an immersive experience that static images simply cannot match.', bgImage: AnimImage, focused: '3D Animation' })} />
                        <ServiceItem name="Construction Design Visualization" number="05" focused={selectedService.focused === 'Construction Design Visualization'} onClick={() => setSelectedService({ title: 'Construction Design Visualization', desc: 'Our Construction Design Visualization services are tailored to turn your architectural and engineering concepts into vivid, detailed visual representations. We believe that a well-visualized design is key to successful project planning, communication, and execution. Our services provide a clear and tangible view of your construction projects before the actual building process begins.', bgImage: ConstImage, focused: 'Construction Design Visualization' })} />
                    </div>
                </div>
            </Container>
        </div>
